...
## 🚨 BREAKING CHANGE - API v0.23.0 (January 28, 2025)

**User endpoints have been consolidated for consistency. Update your code:**

| Old Endpoint | New Endpoint |
|--------------|--------------|
| `GET /api/v1/me` | `GET /api/v1/users/me` |
| `PUT /api/v1/me` | `PUT /api/v1/users/me` |
| `PATCH /api/v1/user/profile/physical` | `PATCH /api/v1/users/me/physical` |
| `GET /api/v1/user/preferences` | `GET /api/v1/users/me/preferences` |
| `PATCH /api/v1/user/preferences` | `PATCH /api/v1/users/me/preferences` |
| `GET /api/v1/user/foods` | `GET /api/v1/users/me/foods` |
| `POST /api/v1/user/foods` | `POST /api/v1/users/me/foods` |
| `GET /api/v1/user/foods/search` | `GET /api/v1/users/me/foods/search` |
| `GET /api/v1/user-exercises` | `GET /api/v1/users/me/exercises` |
| `POST /api/v1/user-exercises` | `POST /api/v1/users/me/exercises` |
| `GET /api/v1/user-exercises/{id}` | `GET /api/v1/users/me/exercises/{id}` |
| `DELETE /api/v1/user-exercises/{id}` | `DELETE /api/v1/users/me/exercises/{id}` |

**Why?** All user-related endpoints are now consistently grouped under `/users/me/*` for better API cohesion.

**Action Required:** Update all affected endpoint paths in your iOS code. All documentation has been updated to reflect the new structure.
...
#### AI Wellness Features (NEW)
| Document | What You'll Build | Dependencies |
|----------|-------------------|--------------|
| [ai-insights.md](features/ai-insights.md) | AI-powered wellness insights | Auth + Tracking data |
| [goals-ai.md](features/goals-ai.md) | AI goal suggestions and tips | Auth + Goals + Tracking |
| [consultations-enhanced.md](ai-consultation/consultations-enhanced.md) | Multi-persona AI chat (WebSocket) | Auth + Profile + Starscream |
| [cross-feature-integration.md](cross-feature-integration.md) | Integrate all AI features | All AI features above |

---

### 🤖 AI Wellness Features (NEW - Most Advanced)
*AI-powered insights, goal suggestions, and real-time chat*

| Document | What You'll Learn | Time |
|----------|-------------------|------|
| [ai-insights.md](features/ai-insights.md) | AI wellness insights with filtering | 2-3 days |
| [goals-ai.md](features/goals-ai.md) | AI goal suggestions and tips | 1-2 days |
| [consultations-enhanced.md](ai-consultation/consultations-enhanced.md) | Multi-persona chat with WebSocket | 3-4 days |
| [cross-feature-integration.md](cross-feature-integration.md) | Connect all AI features seamlessly | 1-2 days |

**Prerequisites:** Auth + Profile + Goals + at least one tracking feature + Starscream (for chat)
...
### Week 7-8: AI Wellness Features (Optional, High Value)
- AI Insights → [`features/ai-insights.md`](features/ai-insights.md) (2-3 days)
- Goals AI → [`features/goals-ai.md`](features/goals-ai.md) (1-2 days)
- AI Consultations → [`ai-consultation/consultations-enhanced.md`](ai-consultation/consultations-enhanced.md) (3-4 days)
- Cross-Feature Integration → [`cross-feature-integration.md`](cross-feature-integration.md) (1-2 days)

**Deliverable:** Complete AI wellness platform with insights, suggestions, and coaching
...
- **AI Insights** require at least one tracking feature (nutrition, workouts, mood, journal)
- **Goals AI** require Goals + at least one tracking feature
- **AI Consultations** require Profile + at least one tracking feature + Starscream library
...
| **AI Insights** | 4 | Medium | [features/ai-insights.md](features/ai-insights.md) |
| **Goals AI** | 2 | Medium | [features/goals-ai.md](features/goals-ai.md) |
| **AI Chat** | 6 + WS | Complex | [ai-consultation/consultations-enhanced.md](ai-consultation/consultations-enhanced.md) |
...
### AI Wellness Features (NEW)
- [ai-insights.md](features/ai-insights.md)
- [goals-ai.md](features/goals-ai.md)

### AI Consultation
- [consultations-enhanced.md](ai-consultation/consultations-enhanced.md)

### Cross-Feature Integration
- [cross-feature-integration.md](cross-feature-integration.md)
