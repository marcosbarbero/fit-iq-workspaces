...
//  Schema version 7: Adds foodType field to SDMealLogItem for nutrition tracking
//
...
enum SchemaV7: VersionedSchema {
    ...
    // MARK: - Reuse unchanged models from V6

    typealias SDDietaryAndActivityPreferences = SchemaV6.SDDietaryAndActivityPreferences
    typealias SDOutboxEvent = SchemaV6.SDOutboxEvent

    // MARK: - Models redefined to work with SchemaV7.SDUserProfile
    // All models with relationships to SDUserProfile must be redefined in V7

    // MARK: - SDPhysicalAttribute (redefined for SchemaV7.SDUserProfile compatibility)
    ...
    // MARK: - SDActivitySnapshot (redefined for SchemaV7.SDUserProfile compatibility)
    ...
    // MARK: - SDProgressEntry (redefined for SchemaV7.SDUserProfile compatibility)
    ...
    // MARK: - SDSleepStage (unchanged from V6)
    ...
    // MARK: - SDSleepSession (redefined for SchemaV7.SDUserProfile compatibility)
    ...
    // MARK: - SDMoodEntry (redefined for SchemaV7.SDUserProfile compatibility)
    ...
    // MARK: - SDMealLogItem (UPDATED in V7 - adds foodType)

    /// Meal log item model for individual food items parsed from meal logs
    ///
    /// V7 Changes: Added `foodType` field to classify items as food/drink/water
    /// for water intake tracking and beverage calorie insights.
    @Model final class SDMealLogItem {
        ...
        /// NEW in V7: Enables water intake tracking and beverage insights
        ...
        init(
            ...
            carbs: Double,
            fat: Double,
            foodType: String = "food",  // NEW in V7
            fiberG: Double? = nil,
            sugarG: Double? = nil,
            ...
            self.carbs = carbs
            self.fat = fat
            self.foodType = foodType  // NEW in V7
            self.fiberG = fiberG
            self.sugarG = sugarG
    ...
    ///
    /// Redefined in V7 to use updated SDMealLogItem with foodType field.
    @Model final class SDMeal {
        ...
        /// Total carbohydrates in grams (computed by backend)
    ...
    // MARK: - SDUserProfile (modified - no changes, just redefined for schema)
    ...
    static var models: [any PersistentModel.Type] {
        [
            SchemaV7.SDUserProfile.self,
            SchemaV7.SDDietaryAndActivityPreferences.self,
            SchemaV7.SDPhysicalAttribute.self,
            SchemaV7.SDActivitySnapshot.self,
            SchemaV7.SDProgressEntry.self,
            SchemaV7.SDOutboxEvent.self,
            SchemaV7.SDSleepSession.self,
            SchemaV7.SDSleepStage.self,
            SchemaV7.SDMoodEntry.self,
            SchemaV7.SDMeal.self,
            SchemaV7.SDMealLogItem.self,  // UPDATED in V7
        ]
    }
}
